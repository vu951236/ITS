    ...
    def refresh_camera(self):
        ...
        for attempt in range(max_attempts):
            try:
                ...
                self.cap.set(cv2.CAP_PROP_FRAME_WIDTH, 160) # Giảm độ phân giải 
    ...
    def update_camera(self):
        if self.is_running and self.cap:
            ...
            if ret and frame is not None and frame.size > 0:
                ...
                frame_display = cv2.resize(frame_rgb, (320, 240)) # Giảm độ phân giải hiển thị để tối ưu 
    ...
    def update_performance_metrics(self):
        if self.is_running:
            try:
                ...
                cpu_usage = self.process.cpu_percent(interval=1.0)  # Tăng interval lên 1 giây
